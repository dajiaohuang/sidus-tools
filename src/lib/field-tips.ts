...
const TIPS: Record<string, string> = {
  ...
  'track samples': 'Number of lat/lon samples on the ground track.',
  'inclination i': 'Orbital inclination i.',
  'tle (sgp4/sdp4)': 'Two-line element set; propagated with satellite.js SGP4/SDP4.',
  'two-body kepler': 'Spherical two-body Kepler, no J2.',
